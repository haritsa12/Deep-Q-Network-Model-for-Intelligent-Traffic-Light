...
def import_train_configuration(config_file):
    ...
    config['total_cars'] = content['simulation'].getint('total_cars')
    config['green_duration'] = content['simulation'].getint('green_duration')
    config['yellow_duration'] = content['simulation'].getint('yellow_duration')
    config['total_layers'] = content['model'].getint('total_layers')
    config['width_layers'] = content['model'].getint('width_layers')
    config['batch_size'] = content['model'].getint('batch_size')
    config['alpha'] = content['model'].getfloat('alpha')
    config['epoch'] = content['model'].getint('epoch')
    config['memory_size_min'] = content['memory'].getint('memory_size_min')
    config['memory_size_max'] = content['memory'].getint('memory_size_max')
    config['total_states'] = content['agent'].getint('total_states')
    config['total_actions'] = content['agent'].getint('total_actions')
