...
class Simulation:
    def __init__(self, Model, TrafficGenerator, sumo_cmd, max_steps, green_duration, yellow_duration, total_states, total_actions):
        self._Model = Model
    ...
    def run(self, episode):
        ...
        while self._step < self._max_steps:
            ...
            action = self.action_selector(current_state)
    ...
    def action_selector(self, state):
        ...
        """
        return np.argmax(self._Model.predict_neuron(state))
